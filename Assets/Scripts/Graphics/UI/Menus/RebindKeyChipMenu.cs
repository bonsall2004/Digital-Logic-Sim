	...
	public static class RebindKeyChipMenu
	{
		...
		public static void DrawMenu()
		{
			...
			using (UI.BeginBoundsScope(true))
			{
				...
				UI.DrawText(KeyStrings[chosenKey], theme.FontBold, theme.FontSizeRegular * 1.5f, UI.PrevBounds.Centre, Anchor.TextCentre, Color.white);
		...
		public static void OnMenuOpened()
		{
			...
			chosenKey = keyChip.activationKey;
		}
	}
}